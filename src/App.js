...
import DipomaInEnglish from './components/Pages/DipomaInEnglish';
  ...
  return (
   ...
   <Router>
      ...
      <Switch>
        ...
        <Route path='/authorized-partner' exact component={AuthorizedPartnership} />
        <Route path='/our-learning-model' exact component={OurLearningModel} />
        <Route path='/skills' exact component={CenturySkills21} />
        <Route path='/career-dev' exact component={CareerDevWorkExperiences} />
        <Route path='/become-student' exact component={BecomeStudent} />
        <Route path='/exams&Certifications' exact component={ExamsCertification} />
          <Route path='/diploma-in-english' exact component={DipomaInEnglish} />
